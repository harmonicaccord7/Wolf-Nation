...
export function Header(){
  return <>
    ...
    <header className="header shell">
      ...
      <div className="actions"><Link className="iconButton" href="/search" aria-label="Search">⌕</Link><Link className="outlineButton" href="/auth">Account sign in</Link><Link className="goldButton" href="/newsletter#newsletter-signup">Newsletter</Link></div>
      <MobileNav/>
    </header>
  </>
}

...
- Candidate application head is `b1c97c060a43350df0f6fc447385ee35d252300b`; corrected CI run `34760828951` is the current browser evidence. PR #21 remains draft/open and production `main` is unchanged.

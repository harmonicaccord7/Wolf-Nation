...
- Screenshot review also found pale section labels on light intelligence/contact backgrounds, desktop pill styles narrowing phone drawer links, and a horizontal flex basis inflating the stacked newsletter field to 280px tall. Scoped CSS corrections address all three.

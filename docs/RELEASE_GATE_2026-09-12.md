...
| Data and models | Official refresh stored 45 events and full model inputs; four descriptive modules emitted observed values; two abstained. Eighteen daily BTC replay windows are real, exploratory evidence. Charts have sources, range controls and accessible inspection. | Validate the promised predictive models with suitable history and frozen forward calls. K-EDGE has no calibrated predictions/outcomes. A short replay cannot close that requirement. |
...
- Refresh request 2122: HTTP 200; 45 events; one draft; no publication or sending.
- Reproducible model run: `cc2025dc-3277-4da8-9a64-e6d24b735bf5` at `2026-09-12T08:59:44.230Z`.
- Snapshot SHA-256: `063d850aaf4ac5486009ac4334108f8d546f6270ce7108c43eaadd128c7d8515`.

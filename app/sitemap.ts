...
export default async function sitemap():Promise<MetadataRoute.Sitemap>{
 ...
 const staticRoutes=['','/markets','/bitcoin','/crypto','/macro','/options','/africa','/business','/technology','/learn','/research','/track-record','/impact-map','/status','/about','/methodology','/contact','/disclosures','/corrections','/privacy','/terms']
